        ...
        <form action="" method="post" id="detailinfo">
            ...
            <div id="fourth_st">
                ...
                <div class="form">
                    ...
                    <input type="checkbox" name="agree" id="agree" value="YES" /><div>I agree the Terms & Condtion of American CPN</div>
                </div>      <!-- clearfix --><div class="clear"></div><!-- /clearfix -->
               
                <input class="send submit" type="submit" name="submit_4" id="submit_4" value="" />            
            </div>
