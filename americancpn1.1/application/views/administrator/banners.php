                            ...
                            if ($banners != 0 && count($banners) > 0) {
                                foreach ($banners as $key => $banner) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td><img src="<?php echo base_url(BANNER_IMAGE_PATH.$banner->path); ?>" width="100" > </td>
                                        <td><img src="<?php echo base_url(BANNER_IMAGE_PATH.$banner->mimage); ?>" width="100" > </td>
                                        <td><img src="<?php echo base_url(BANNER_IMAGE_PATH.$banner->rimage); ?>" width="100" > </td>
