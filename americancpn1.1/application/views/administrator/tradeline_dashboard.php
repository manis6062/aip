<div id="content" class="span10">
    ...
    <a data-rel="tooltip" class="well span3 top-block" href="<?php echo base_url().'administrator/tradelineowner/cardList';?>" data-original-title="<?php  echo $cardinfo->countcard ; ?> Tradelines.">
