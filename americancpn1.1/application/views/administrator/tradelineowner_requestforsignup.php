                    ...
                    <?php
                        ...
                        if($error)
                        {
                         ...
                         <?php $attributes = array('class' => 'formular', 'id' => 'form');
								echo form_open_multipart(ADMIN_PATH . 'tradelineowner_request/add', $attributes);
                           ?>
                    <table class="form">
                    ...
                    <div class="box-content">
                        <?php
                            ...
                            <?php if (in_array('request', $allowed)) { ?>
                                <a href="<?php echo site_url(ADMIN_PATH.'tradelineowner/add'); ?>" class="btn btn-primary">New</a>
                        <?php } ?>
                        <?php $attributes = array('class' => 'formular', 'id' => 'form');
						echo form_open_multipart(ADMIN_PATH.'tradelineowner_request/remove_checked', $attributes);
                        ?>
                    ...
                    if ($list != 0 && count($list) > 0) {
                        ...
                        foreach ($list as $values) {
                            ...
                            <tr class="item">
                                ...
                                <td class="action">
                                    <a href="<?php echo site_url(ADMIN_PATH.'tradelineowner_request/deleteAction/' . $values -> request_id); ?>"  onclick="return confirm('Make Sure Before You Delete This Record');"><img src="<?php echo base_url(); ?>/style/img/delete.png" alt="delete"></a> 
                                </td>
                            </tr>
                            <?php $count++;
							}
