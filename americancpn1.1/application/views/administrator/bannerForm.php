    ...
    $("#banner").bootstrapValidator({
        ...
        fields: {
            ...
            path:{
                validators:{
                    notEmpty:{
                        message: 'The background image is required and can\'t be empty'
                    }
                }
            },
            mimage:{
                validators:{
                    notEmpty:{
                        message: 'The middle image is required and can\'t be empty'
                    }
                }
            },
            rimage:{
                validators:{
                    notEmpty:{
                        message: 'The right image is required and can\'t be empty'
                    }
                }
            },
            description:{
