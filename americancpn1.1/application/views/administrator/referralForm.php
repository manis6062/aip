<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'administrator/referral'; ?>">Referral</a></li>
            <li class="active">add</li>
        </ol>
    </section>
    <section class="content">
        <div class="row">
            <form action="<?php echo base_url() . 'administrator/referral/addreferral'; ?>" method="post"
                  id="tradeline">
                <div class="col-md-6">
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">referrals Information:</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">referrals preferences:</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
...
<script>
    ...
    $(function () {
        $("#broker_email_id").autocomplete({
            source: "<?php echo base_url('administrator/referral/get_brokers')?>"
        });
    });
