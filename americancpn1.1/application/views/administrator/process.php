                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <a href="#" id="process_title" data-type="text" data-emptytext="enter title "><?php echo $process->process_title; ?></a>
                            </div>
                            <div class="form-group col-md-12">
                                <?php echo form_label('caption', 'Caption'); ?>
                                <a href="#" id="process_caption" data-type="text" data-emptytext="enter caption "><?php echo $process->process_caption; ?></a>
                            </div>
                            <div class="form-group col-md-12">
                                <?php echo form_label('description', 'Description'); ?>
                                <a href="#" id="process_description" data-type="textarea" data-emptytext="enter description "><?php echo $process->process_description; ?></a>
                            </div>
                        </div>
