				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							...
							<li  class="active" ><a href="<?php echo base_url('administrator/mail/sent_mail');?>"><i class="fa fa-envelope-o"></i> Sent<span class="label label-primary pull-right"></span></a></li>
				...
				<div class="box box-primary">
					...
					<div class="box-body no-padding">
						<div class="mailbox-controls">
							...
							<a href="<?php echo base_url('administrator/mail/sent_mail');?> " <button class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
...
<!--															   value="--><?php //echo $values->id .'/'. $values->receiver_id ?><!--"/></td>-->
													<td class="mailbox-name"><a
															href="<?php echo base_url('administrator/mail/read_mail') . '/' . $values->id .'/'.$values->receiver_id ?>">
                                                            <?php if(empty($values->sender))
                                                            { echo $values->receiver_name ;}
                                                            else
                                                            { echo $values->sender ; }?></a></td>
													<td class="mailbox-subject"><b><?php echo $values->subject ?></b>
														- <?php echo(strlen($values->msg) >= 10) ?>...
													</td>
