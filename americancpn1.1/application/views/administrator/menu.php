...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form action="<?php echo base_url() . 'administrator/menu/updateMenu/'.$menu->id; ?>" method="post"
                  id="menu">
                <div class="col-md-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        echo form_input(array('value' => $menu->menu_name,'class' => 'form-control', 'id' => 'menu_name', 'name' => 'menu_name','width' => '40'));
                                        ?>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        echo form_dropdown('menu_type', $data, $menu->menu_type, array('id' => 'menu_type', 'class' => 'form-control select2' ));
                                        ?>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        echo form_dropdown('status', $data ,set_value('status')==""?$menu->status:set_value('status'), array('id' => 'status', 'class' => 'form-control select2'));
