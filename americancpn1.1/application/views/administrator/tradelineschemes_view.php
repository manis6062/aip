			...
			<div class="box span12">
				...
				<div class="box-content">
					...
					<?php $attributes = array('class' => 'formular', 'id' => 'form');
						echo form_open_multipart(ADMIN_PATH . 'tradeline/generatescheme', $attributes);
					?>
					<table class="form">
						<strong>Card Type</strong>: <?php echo $getdetailsofcard->card_type; ?><br/>
					...
					<?php echo form_close(); ?>
					<a href="<?php echo base_url() . 'administrator/tradelineowner/carddetails/' . $owner_id . '/' . str_replace(" ", "_", $owner_name); ?>">Back
						To Card Details</a>
				</div>
			</div>
			<!--/span-->
			...
			<div class="box-content">
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<tr>
						...
						<?php if ($usertype == 2) {
							echo "<th>Tradeline Owner Name</th>";
							// echo "<th>Tradeline Owner Address</th>";
							// echo "<th>Tradeline Owner Email</th>";
						...
						if ($schemeList != 0 && count($schemeList) > 0) {
							...
							foreach ($schemeList as $values) {
								...
								<tr class="item">
									...
									<?php if ($usertype == 2) { ?>
										<td><?php echo $values->tradeline_owner_name; ?></td>
										<!-- <td><?php echo $values->tradeline_owner_address; ?></td>
                                	<td><?php echo $values->tradeline_owner_email; ?></td>
