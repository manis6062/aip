                    ...
                    <tr>
                        ...
                        <th colspan="3"></th>
							...
							?>">
								...
								<td class""><?php echo $val -> card_type; ?></td>	
							    ...
							    <td>
							    	<?php if($val->payment_status_referral=="Unpaid")
								 {?>
								 	<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/PaymentStatus_Referral/'  .$val->card_sell_id); ?>" title="Paid"> </a>
								

								 	<a class="btn btn-success" href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/PaymentStatus_Referral/'.$val->card_sell_id) ?>"
								 		     onclick="return confirm ('Are you sure <?php echo $val -> firstname . ' ' . $val -> lastname; ?> paid for this card?') ";

							    		    title="Paid"> <?php echo $val -> payment_status_referral ?></a>

<!--							    		   < title="Payment Status"> --><?php //echo $val -> payment_status_referral?><!--</a>-->
							    ...
							    <td class""><?php echo $val -> payment_paid_date_referral; ?></td>	
