				...
				<div class="box box-primary">
					...
					<div class="box-body no-padding">
						<div class="mailbox-controls">
							...
							<a href="<?php echo base_url('administrator/mail/trash_mail');?> " <button class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
...
<!--												<td><input type="checkbox" name = "checkbox[]" value="--><?php //echo $values->id ?><!--"/></td>-->
												<td class="mailbox-name"><a href="<?php echo base_url('administrator/mail/read_mail'). '/' .$values->id?>">
                                                        <?php
