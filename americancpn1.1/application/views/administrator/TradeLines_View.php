        ...
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <!-- <?php if (($this->session->userdata('ADMIN_AUTH_ROLE')==4) && ($this->session->userdata('ADMIN_AUTH_ROLE')==5)){ ?>
                                <a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/addCard/'.$to_id.'/'.$to_name); ?>" class="btn btn-primary">Add New Card</a>
                        <?php } ?> -->
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    <thead>
                    <tr>
                        <th>S.No.</th>
                        <th>TradeLines Owner<?php echo '&nbsp;&nbsp;&nbsp' ; ?><img src="<?php echo base_url(); ?>/style/img/sort.png"> </th>
                    ...
                    if( $cardList !=0 && count($cardList) > 0)
                    {
                        ...
                        foreach($cardList as  $values)
                        {
                            ...
                            <tr class="item">
                                ...
                                <td><a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/creditcard_update/'  .$values->to_id. '/'. $values -> card_id.'/'.$values->to_fname.'_'.$values->to_lname); ?>" title="Click to edit"> <?php echo $values -> to_fname.' '.$values->to_lname;?></a></td>
                                ...
                                <td><a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/creditcard_update/' .$values->to_id. '/'. $values -> card_id.'/'.$values->to_fname.'_'.$values->to_lname); ?>" title="Click to edit"> <?php echo $values -> card_name;?></a></td>
                                <td><a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/creditcard_update/'  .$values->to_id. '/'. $values -> card_id.'/'.$values->to_fname.'_'.$values->to_lname); ?>" title="Click to edit"> <?php echo $values -> card_type;?></a></td>
