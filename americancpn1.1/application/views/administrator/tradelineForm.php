<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'administrator/tradeline/tradelines'; ?>">tradelines</a></li>
        ...
        <div class="row">
            <form action="<?php echo base_url() . 'administrator/tradeline/addTradeline'; ?>" method="post"
                ...
                <div class="col-md-6">
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">tradeline information:</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <?php
                                    echo form_label('tradeline owner name:');
                            ...
                            <div class="row">
                                <div class="form-group col-md-5">
                                    ...
                                    echo form_dropdown('type', $card_types, $this->session->userdata(USER_ID), array('class' => 'form-control select2', 'id' => 'type'))
                                    ?>
                                </div>
                                <div class="form-group col-md-5">
                ...
                <div class="col-md-6">
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">tradeline preferences:</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-5">
                                    <label class="control-label" for="charge">tradeline cost:</label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    <?php echo form_label('activate tradeline:', 'activate', array('class' => 'control-label'));
...
<script>
    ...
    $("#type").change(function () {
        $.get("<?php echo base_url() . 'administrator/tradeline/getCardNames'; ?>", {
