				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
							...
							?>">
								...
								<td class""><?php if($val -> card_sell_added_date){
								 ...
								 {?>
								 	<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/PaymentStatus/'  .$val->card_sell_id); ?>"  onclick="return confirm ('Are you sure <?php echo $val -> firstname . ' ' . $val -> lastname; ?> paid for this card?') "; title="Paid"> <?php echo $val -> payment_status;?></a>
								...
								echo "Paid";
								 ...
								 <td class""><?php echo $val -> payment_paid_date_tradelineowner; ?></td>	
