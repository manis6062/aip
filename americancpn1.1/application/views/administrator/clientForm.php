<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'administrator/client'; ?>">Clients</a></li>
            <li class="active">add</li>
        </ol>
    </section>
    <section class="content">
        <div class="row">
            <form action="<?php echo base_url() . 'administrator/client/addClient'; ?>" method="post"
                  id="line">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">Clients preferences:</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="phone" class="control-label">SSN No.:</label>
...
<script>
    ...
    $(function () {
        $("#broker_email_id").autocomplete({
            source: "<?php echo base_url('administrator/client/get_brokers')?>"
        });
    });
