		...
		<div class="box span12">
			...
			<div class="box-content">
				...
				<?php if (($usertype != 1) && ($usertype != 3)) { ?>
					<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/addCard/' . $owner_id . '/' . $owner_name); ?>"
						...
						if ($cardList != 0 && count($cardList) > 0) {
							...
							foreach ($cardList as $values) {
								...
								<tr class="item">
									...
									<td>
										<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/creditcard_update/' . $owner_id . '/' . $values->card_id . '/' . $owner_name); ?>"
									...
									<td>
										<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/creditcard_update/' . $owner_id . '/' . $values->card_id . '/' . $owner_name); ?>"
										   title="Click to edit"> <?php echo $values->card_type; ?></a></td>
									...
									<?php if ($usertype != 1) { ?>
										<td class="action" style="width:100px">
											<?php if (($values->card_sell_com) == 0 && ($values->card_sell_pro) == 0) { ?>
												<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner/delete_card/' . $owner_id . '/' . $values->card_id . '/' . $owner_name); ?>"
