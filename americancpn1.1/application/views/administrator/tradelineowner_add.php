					...
					<div class="box-content">
						...
						<?php $attributes = array('class' => 'formular');
							if (!empty($photoRecord)) {
								echo form_open(ADMIN_PATH . 'tradelineowner/update', $attributes);
							} else {
								echo form_open(ADMIN_PATH . 'tradelineowner/addAction', $attributes);
							}
						?>
						<table class="form">
		                   ...
		                   <?php $data = array('name' => 'address', 'id' => 'address', 'placeholder' => 'Street, Unit, State, Zip Code', 'value' => set_value('address'), 'class' => 'form-control',);
							...
							<tr>
								...
								<td class="col2">
									...
									<a href="<?php echo site_url(ADMIN_PATH . 'tradelineowner'); ?>"
