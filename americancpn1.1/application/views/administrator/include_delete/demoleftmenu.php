...
<div class="container-fluid">
        <div class="row-fluid">
            <div class="span2 main-menu-span">
                ...
                <?php }?>
                <?php if (in_array('referrer_view', $allowed)) {?>
                <div class="well nav-collapse sidebar-nav">    
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        <li class="nav-header hidden-tablet">referrer Management</li>
                        <li><a title="" class="ajax-link" data-rel="tooltip"><i class="icon-home"></i><span class="hidden-tablet">referrer List</span></a></li>
                        <!-- <li><a title="" class="ajax-link" data-rel="tooltip"><i class="icon-home"></i><span class="hidden-tablet">referrer Notes</span></a></li> -->
                        <?php if($this->session->userdata(ADMIN_AUTH_TYPE) != 'client'){ ?><li><a title="" class="ajax-link" data-rel="tooltip"><i class="icon-home"></i><span class="hidden-tablet">referrer Emails</span></a></li><?php }?>
                    </ul>                    
                </div>
                <?php }?>
                ...
                <div class="well nav-collapse sidebar-nav">    
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a title="" class="ajax-link" data-rel="tooltip"><i class="icon-home"></i><span class="hidden-tablet">referrer Agent Portal</span></a></li>
                    </ul>                    
                </div>
                <?php }?>
                <div class="well nav-collapse sidebar-nav">
				<ul class="nav nav-tabs nav-stacked main-menu">
					...
					<?php if (in_array('line_view', $allowed)) {?>  <li>
						<a title="" class="ajax-link" data-rel="tooltip" href="#"><i class="icon-home"></i><span class="hidden-tablet">Lines for Purchase</span></a>
					</li><?php }?>
					<li>
						<a title="" class="ajax-link" data-rel="tooltip"><i class="icon-home"></i><span class="hidden-tablet">Choose and Charge</span></a>
					</li>
					<?php if (in_array('line_owner', $allowed)) {?>  <li>
						<a title="" class="ajax-link" data-rel="tooltip"><i class="icon-home"></i><span class="hidden-tablet">Lines Owners</span></a>
					</li><?php }?>
					<?php if (in_array('line_view', $allowed)) {?>  <li>
						<!-- <a title="" class="ajax-link" data-rel="tooltip" href="#"><i class="icon-home"></i><span class="hidden-tablet">Lines Training</span></a> -->
					</li><?php }?>
				</ul>
			</div>
