                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <a href="#" id="faq_question" data-type="text" data-emptytext="enter question "><?php echo $faq->faq_question; ?></a>
                            </div>
                            <div class="form-group col-md-12">
                                <?php echo form_label('answer', 'Answer'); ?>
                                <a href="#" id="faq_answer" data-type="textarea" data-emptytext="enter answer "><?php echo $faq->faq_answer; ?></a>
                            </div>
                        </div>
