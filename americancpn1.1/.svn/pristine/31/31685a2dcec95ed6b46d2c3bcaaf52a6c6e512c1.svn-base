...
class RecurringModel extends CI_Model {
	...
	public $API_UserName="pradhan10_api1.yahoo.com";
		public $API_Password="1402823474";
		public $API_Signature="ABlaSnJ7Sfu8cyCf8k3uJYlRJBjmAw.mD8G4x.b4gqiR7MjxlKRcTiWN";
	...
	*/
	...
	function CreateRecurringPaymentsProfile()
	{
		...
		$nvpstr.="&PROFILESTARTDATE=".urlencode("2015-01-27T0:0:0");
