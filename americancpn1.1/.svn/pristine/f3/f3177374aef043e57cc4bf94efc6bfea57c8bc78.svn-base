                    ...
                    <div class="box-content">
                        ...
                        if($error)
                        {
                         ...
                         <?php $attributes = array('class' => 'formular', 'id' => 'form');
                                echo form_open_multipart(ADMIN_PATH . 'album/add', $attributes);
                           ?>
                    <table class="form">
                        <tr>
                            <td class="col1">
                      ...
                      <tr>
                            ...
                            <td class="col2">
                                ...
                                <?php $data = array('name' => 'album_descript', 'id' => 'album_descript', 'value' => set_value('album_descript'), 'class' => 'medium', 'rows' => '5', );
                        ...
                        <tr>
                            ...
                            <td>
                              <?php $extra = 'style="width:390px;" class="chzn-select medium select"';
                                ...
                                echo form_dropdown('album_status', $options, set_value('album_status'), $extra);
                                ?> 
                            </td>
                        </tr>
